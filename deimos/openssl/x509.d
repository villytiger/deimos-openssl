...
/+mixin DEFINE_STACK_OF!(X509_NAME_ENTRY);+/

/+mixin DEFINE_STACK_OF!(X509_NAME);+/
...
/+mixin DEFINE_STACK_OF!(X509_EXTENSION);+/

struct x509_attributes_st;
alias x509_attributes_st X509_ATTRIBUTE;

/+mixin DEFINE_STACK_OF!(X509_ATTRIBUTE);+/
...
/+mixin DEFINE_STACK_OF!(X509_TRUST);+/
...
/+mixin DEFINE_STACK_OF!(X509_REVOKED);+/

typedef struct X509_crl_info_st X509_CRL_INFO;

/+mixin DEFINE_STACK_OF!(X509_CRL);+/
...
/+mixin DEFINE_STACK_OF!(X509_INFO);+/
}
...
X509_CRL_METHOD* X509_CRL_METHOD_new(ExternC!(int function(X509_CRL* crl)) crl_init,
                                     ExternC!(int function(X509_CRL* crl)) crl_free,
                                     ExternC!(int function(X509_CRL* crl,
                                                          X509_REVOKED** ret,
                                                          ASN1_INTEGER* ser,
                                                          X509_NAME* issuer)) crl_lookup,
...
int X509_signature_print(BIO* bp,X509_ALGOR* alg,
                         ASN1_STRING* sig);
